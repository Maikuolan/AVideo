...
$t['A client error occurred [2]: %s'] = 'Chyba na straně klienta [2]: %s';
$t['A client error occurred: %s'] = 'Chyba na straně klienta: %s';
$t['A service error occurred [1]: %s'] = 'Chyba na služby [1]: %s';
$t['A service error occurred: %s'] = 'Chyba na služby: %s';
$t['About'] = 'O nás';
...
$t['Help'] = 'Nápověda';
$t['Here you can find help, how this platform works.'] = 'Zde můžete naleznou nápovědu, jak tato platforma funguje.';
...
$t['Only you can see this, because you are an admin.'] = 'Jen vy můžete vidět toto, jelikož jste administrátorem.';
...
$t['Thanks'] = 'Děkujeme';
$t["The <a href='{videoLink}'>{videoName}</a> video was reported as inappropriate from {user} "] = "Video, od {user}, <a href='{videoLink}'>{videoName}</a> bylo nahlášeno jako nevhodné ";
...
$t['The {videoName} video was reported as inappropriate'] = 'Video {videoName} bylo nahlášeno jako nevhodné';
$t['Themes'] = 'Motivy';
...
$t['Use tls OR ssl'] = 'Použijte tls NEBO ssl';
...
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'Nikoho jsme nemohli upozornit %s, ale označili jsme to za nevhodné';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = 'Nemohli jsme upozornit vlastníka videa %s, ale označili jsme to za nevhodné';
...
$t['You already reported this video'] = 'Toto video jste již nahlásili';
...
$t['seconds'] = 'sekundy';
$t['space'] = 'mezerník';
$t['Unzip and upload/replace <b>all</b> of the files. Only the videos folder should stay untouched.'] = 'Rozbalte a nahrajte/nahraďte <b>všechny</b> soubory. Jen adresář pro videa by měl zůstat nedotčený.';
...
$t['year'] = 'rok';
$t['years'] = 'roky';
$t['youtube-dl uses Python and some servers do not come with python by default. To install Python type:'] = 'youtube-dl používá Python. Některé servery jej nemají ve výchozí instalaci. Pro doinstalování použijte příkaz:';
