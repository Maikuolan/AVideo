...
$t['A client error occurred [2]: %s'] = 'Ein Fehler im Client ist aufgetreten [2]: %s';
$t['A client error occurred: %s'] = 'Ein Fehler im Client ist aufgetreten: %s';
$t['A service error occurred [1]: %s'] = 'Ein Service-Fehler ist aufgetreten [1]: %s';
...
$t['Do you want to report this video as inappropriate?'] = 'Willst Du dieses Video als unangemessen melden?';
...
$t['Some material may not be inappropriate for children under 13'] = 'Einige Materialien sind möglicherweise nicht für Kinder unter 13 Jahren geeignet';
...
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'Wir konnten niemanden benachrichtigen (%s), aber wir haben es als unangemessen markiert';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = 'Wir konnten den Videoinhaber %s nicht benachrichtigen, haben das Video jedoch als nicht geeignet markiert';
...
$t['You already reported this video'] = 'Du hast das Video schon gemeldet';
...
$t['Your %s locale dir is not writable'] = 'Ihr %s locale dir ist nicht beschreibbar';
...
$t['year'] = 'Jahr';
$t['years'] = 'Jahre';
$t['youtube-dl uses Python and some servers do not come with python by default. To install Python type:'] = 'Youtube-dl verwendet Python und einige Server haben Python nicht als Standard installiert. Um Python zu installieren tippe:';
