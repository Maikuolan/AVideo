...
$t['A client error occurred [2]: %s'] = 'Παρουσιάστηκε σφάλμα πελάτη [2]: %s';
$t['A client error occurred: %s'] = 'Παρουσιάστηκε σφάλμα πελάτη: %s';
$t['A service error occurred [1]: %s'] = 'Παρουσιάστηκε κάποιο σφάλμα της υπηρεσίας [1]: %s';
...
$t['Add to'] = 'Προσθήκη';
$t['Admin Menu'] = 'Μενού διαχειριστή';
...
$t['Balance'] = 'Ισοζύγιο';
$t['Block User'] = 'Αποκλεισμός χρήστη';
$t['Both'] = 'Και τα δυο';
$t['Bottom'] = 'Κάτω μέρος';
...
$t['Channel'] = 'Κανάλι';
$t['Channels'] = 'Περιήγηση στα κανάλια';
...
$t['Comment'] = 'Προσθήκη σχολίου';
$t['Comments'] = 'Σχολιασμοί';
...
$t['Show Less'] = 'Λιγότερα';
$t['Show More'] = 'Περισσότερα';
$t['Sign Up'] = 'Εγγραφή';
...
$t['Submit your videos'] = 'Υποβάλετε τα βίντεό σας';
$t['Subscribe'] = 'Εγγραφείτε';
$t['Subscribed to'] = 'Εγγραφή στο';
$t['Subscribed'] = 'Εγγραφήκατε';
...
$t['Watch Later'] = 'Δείτε το αργότερα';
$t['Watching Now'] = 'Δείτε το τώρα';
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'Δεν μπορέσαμε να ειδοποιήσουμε κανέναν %s, αλλά το επισημάναμε ως ακατάλληλο';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = 'Δεν μπορέσαμε να ειδοποιήσουμε τον κάτοχο του βίντεο %s, αλλά το επισημάναμε ως ακατάλληλο';
$t['Yes'] = 'Ναί';
...
$t['months'] = 'μήνες';
$t['newest'] = 'νεότερο';
$t['oldest'] = 'παλαιότερος';
$t['remaining'] = 'υπολείπονται';
...
$t['Buy PPV'] = 'Ενοικίαση';
$t['Accessibility Tools'] = 'Εργαλεία προσβασιμότητας';
$t['Increase Text'] = 'Αύξηση κειμένου';
$t['Decrease Text'] = 'Μείωση κειμένου';
$t['Grayscale'] = 'Κλίμακα του γκρι';
$t['High Contrast'] = 'Υψηλή αντίθεση';
$t['Negative Contrast'] = 'Αρνητική αντίθεση';
$t['Links Underline'] = 'Υπογράμμιση συνδέσμων';
$t['Readable Font'] = 'Ευανάγνωστη γραμματοσειρά';
$t['Reset'] = 'Επαναφορά';
$t['Views Info'] = 'Προβολές';
$t['Compress'] = 'Σύμπτυξη ';
$t['Suggest it'] = 'Προτείνετε το';
$t['Unsuggest it'] = 'Μην το προτείνετε';
$t['Organize Program'] = 'Η λίστα σας';
$t['Remind me'] = 'Υπενθύμιση Live';
$t['Download reminder'] = 'Λήψη υπενθύμισης';
$t['Add to Google calendar'] = 'Προσθήκη στο ημερολόγιο Google';
$t['10 minutes earlier'] = '10 λεπτά νωρίτερα';
$t['30 minutes earlier'] = '30 λεπτά νωρίτερα';
$t['1 hour earlier'] = '1 ώρα νωρίτερα';
$t['2 hours earlier'] = '2 ώρες νωρίτερα';
$t['1 day earlier'] = '1 ημέρα νωρίτερα';
$t['2 days earlier'] = '2 ημέρες νωρίτερα';
$t['1 week earlier'] = '1 εβδομάδα νωρίτερα';
$t['Expand'] = 'Επέκταση';
$t['Started'] = 'Ξεκίνησε';
$t['You have a new like'] = 'Έχετε ένα νέο Like';
$t['Select a user to comment as if you were him'] = 'Επιλέξτε έναν χρήστη για να σχολιάσει σαν να είσασταν εσείς';
