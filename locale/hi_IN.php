...
$t['A service error occurred [1]: %s'] = 'एक सेवा त्रुटि उत्पन्न हुई [1]: %s';
$t['A service error occurred: %s'] = 'एक सेवा त्रुटि उत्पन्न हुई: %s';
$t['About'] = 'के बारे में';
$t['Activate'] = 'सक्रिय';
$t['Active'] = 'सक्रिय';
...
$t['Audio'] = 'ऑडियो';
$t['Browse Channels'] = 'चैनल को ब्राउज़ करें';
$t['Browse'] = 'ब्राउज़ करें';
$t['Browse files'] = 'फाइलों को ब्राउज़ करें';
...
$t['Sorry'] = 'माफ़ कीजिये';
$t['Status'] = 'स्थिति';
$t['The original file for this video does not exists anymore'] = 'इस वीडियो के लिए मूल फाइल अब मौजूद नहीं है';
$t['This e-mail will be used for this web site notifications'] = 'इस ई-मेल का उपयोग इस वेब साइट की सूचनाओं के लिए किया जाएगा';
$t['This value must match with the language files on'] = 'यह मान को भाषा फाइलों के साथ मेल करना चाहिए';
$t['Title'] = 'शीर्षक';
$t['Translated Array'] = 'अनुवादित अर्रे';
$t['Type the code'] = 'कोड टाइप करें';
$t['Type'] = 'प्रकार';
$t['Unable to open file!'] = 'फाइल खोलने में असमर्थ!';
$t['Update AVideo System'] = 'AVideo सिस्टम अपडेट करें';
$t['Update Now'] = 'अभी अपडेट करें';
$t['Update the site configuration'] = 'साइट कॉन्फ़िगरेशन अपडेट करें';
$t['Update version'] = 'संस्करण अपडेट करें';
$t['Update your user'] = 'अपने उपयोगकर्ता को अपडेट करें';
$t['Upload your file'] = 'अपनी फाइल अपलोड करें';
$t['User Form'] = 'उपयोगकर्ता फ़ॉर्म';
$t['User'] = 'उपयोगकर्ता';
$t['Users'] = 'उपयोगकर्ताओं';
$t['Video Form'] = 'वीडियो फॉर्म';
$t['Video re-encoding!'] = 'वीडियो फिर से एन्कोडिंग!';
$t['Videos'] = 'वीडियो';
$t['Views'] = 'चेतावनी';
$t['Warning'] = 'हमने कुल% घ लंबित अपडेट का पता लगाया है, यदि आप इसे अभी करना चाहते हैं तो अब (अपडेट करें) बटन क्लिक करें';
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'हम किसी (%s) को सूचित नहीं कर सके, लेकिन हमने इसे अनुपयुक्त के रूप में चिन्हित कर दिया';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = 'हम वीडियो के स्वामी (%s) को सूचित नहीं कर सके, लेकिन हमने इसे अनुपयुक्त के रूप में चिन्हित कर दिया';
...
$t['Yes, report it!'] = 'हाँ, इसकी रिपोर्ट करें!';
$t['Yes, transfer it!'] = 'हाँ, इसे स्थानांतरित करें!';
$t['Yes, unmute it!'] = 'हाँ, इसे अनम्यूट करें!';
...
$t['Your %s locale dir is not writable'] = 'आपकी श्रेणी हटा दी गई है!';
...
$t['Your comment has NOT been saved!'] = 'आपकी टिप्पणी सहेजी नहीं गई है!';
...
$t['Your configurations has NOT been updated!'] = 'आपका कॉन्फ़िगरेशन अपडेट नहीं किया गया है!';
$t['Your configurations has been updated!'] = 'आपकी भाषा सहेज ली गई है!';
$t['Your encode video resolution is set to %s !'] = 'आपका एन्कोड वीडियो रिज़ॉल्यूशन %s पर सेट है!';
$t['Your language has been saved!'] = 'आपकी भाषा सहेज ली गई है!';
$t['Your maximum file size is:'] = 'आपका अधिकतम फाइल आकार है:';
$t['Your message could not be sent!'] = 'आपका संदेश भेजा नहीं जा सका!';
$t['Your message has been sent!'] = 'आपका सन्देश भेज दिया गया है!';
$t['Your password does not match!'] = 'आपका पासवर्ड मेल नहीं खाता है!';
$t['Your system is up to date'] = 'आपका सिस्टम आधुनिक है';
$t['Your update from file %s is done, click continue'] = 'फाइल %s से आपका अपडेट किया गया है, जारी रखें पर क्लिक करें';
$t['Your user has NOT been deleted!'] = 'आपके उपयोगकर्ता को हटाया नहीं गया है!';
$t['Your user has NOT been saved!'] = 'आपका उपयोगकर्ता सहेजा नहीं गया है!';
$t['Your user has NOT been updated!'] = 'आपके उपयोगकर्ता को अपडेट नहीं किया गया है!';
$t['Your user has been deleted!'] = 'आपके उपयोगकर्ता को हटा दिया गया है!';
$t['Your user has been saved!'] = 'आपका उपयोगकर्ता सहेजा गया है!';
$t['Your user or password is wrong!'] = 'आपका उपयोगकर्ता या पासवर्ड गलत है!';
$t['Your video has NOT been deleted!'] = 'आपका वीडियो हटाया नहीं गया है!';
$t['Your video has NOT been saved!'] = 'आपका वीडियो सहेजा नहीं गया है!';
$t['day'] = 'दिन';
$t['days'] = 'दिन';
$t['description'] = 'विवरण';
$t['hour'] = 'घंटा';
$t['hours'] = 'घंटे';
$t['is Admin'] = 'व्यवस्थापक है';
$t['minute'] = 'मिनट';
$t['minutes'] = 'मिनट';
$t['month'] = 'महीना';
$t['months'] = 'महीने';
$t['newest'] = 'नवीनतम';
$t['oldest'] = 'सबसे पुराने';
$t['remaining'] = 'बचा हुआ';
$t['second'] = 'सेकंड';
$t['seconds'] = 'सेकंड';
$t['tls OR ssl'] = 'tls या ssl';
$t['user'] = 'उपयोगकर्ता';
$t['users'] = 'उपयोगकर्ताओं';
$t['week'] = 'हफ्ता';
$t['weeks'] = 'हफ्ता';
...
$t['Use one of the recommended resolutions'] = 'सुझाए गए प्रस्तावों में से एक का उपयोग करें';
$t['Video Resolution'] = 'वीडियो संकल्प';
$t['Video and Audio Upload'] = 'वीडियो और ऑडियो अपलोड करें';
...
$t['Your user has been updated!'] = 'आपके उपयोगकर्ता को अपडेट कर दिया गया है!';
$t['Your video has been deleted!'] = 'आपका वीडियो हटा दिया गया है!';
$t['Your video has been saved!'] = 'आपका वीडियो सहेजा गया है!';
