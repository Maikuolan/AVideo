...
$t['A client error occurred [2]: %s'] = '클라이언트 오류 발생 [2]: %s';
$t['A client error occurred: %s'] = '클라이언트 오류 발생: %s';
$t['A service error occurred [1]: %s'] = '서비스 오류 발생 [1]: %s';
...
$t['Do you want to report this video as inappropriate?'] = '이 비디오를 부적절하다고 보고하시겠습니까?';
...
$t['Some material may not be inappropriate for children under 13'] = '어떤 물질은 13세 미만 어린이에게 적합하지 않을 수 있다.';
...
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = '누구에게도 알릴 수 없었지만 (%s) 부적합하다고 표시했다.';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = '동영상 소유자 %s에게 알릴 수 없었지만 부적절하다고 표시했습니다';
...
$t['You already reported this video'] = '이 비디오를 이미 보고한 경우';
...
$t['Your %s locale dir is not writable'] = '%s locale dir를 쓸 수 없음';
$t['Your Logo'] = '당신의 로고';
