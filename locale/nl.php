...
$t['A client error occurred [2]: %s'] = 'Er is een probleem opgetreden met de cliënt [2]: %s';
$t['A client error occurred: %s'] = 'Er is een probleem opgetreden met de cliënt: %s';
...
$t['Browse Channels'] = 'Blader door kanalen';
$t['Browse'] = 'Bladeren';
$t['Browse files'] = 'Blader door bestanden';
...
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'We konden niemand op de hoogte stellen (%s), maar we hebben de video gemarkeerd als ongepast';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = 'We konden de eigenaar van de video %s niet op de hoogte stellen, maar we hebben de video gemarkeerd als ongepast';
