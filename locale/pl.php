...
$t['A client error occurred [2]: %s'] = 'Wystąpił błąd klienta [2]: %s';
$t['A client error occurred: %s'] = 'Wystąpił błąd klienta: %s';
...
$t['Copy from encrypted message'] = 'Kopiuj z zaszyfrowanej wiadomości';
...
$t['This video is for fans Only, click here to toggle it'] = 'Ten film jest przeznaczony tylko dla fanów. Kliknij tutaj, aby go przełączyć';
...
$t['Under Maintenance'] = 'Trwają prace konserwacyjne';
...
$t['Video swapped!'] = 'Wideo zamienione !';
...
$t['year'] = 'rok';
$t['years'] = 'lat';
$t['youtube-dl uses Python and some servers do not come with python by default. To install Python type:'] = 'youtube-dl używa Pythona, a niektóre serwery nie są dostarczane z pythonem jako oprogramowanie domyślne; aby zainstalować Pythona wpisz:';
