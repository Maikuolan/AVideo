...
$t['Request Payout'] = 'RВыплата по эквесту';
...
$t['The site will display only a login form to un authenticated users'] = 'Сайт будет отображать только форму входа для неавторизованных пользователей';
...
$t['User must allow each video individually, but this video is not markedfor download'] = 'Пользователь должен разрешить каждое видео по отдельности, но это видео не помечено для скачивания';
...
$t['the files. Only the videos-folder should stay untouched.'] = 'файлы. Только папка с видео должна остаться нетронутой.';
