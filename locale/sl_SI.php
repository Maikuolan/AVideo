...
$t['A client error occurred [2]: %s'] = 'Prišlo je do napake odjemalca [2]: %s';
$t['A client error occurred: %s'] = 'Prišlo je do napake odjemalca: %s';
$t['A service error occurred [1]: %s'] = 'Pojavila se je napaka [1]: %s';
