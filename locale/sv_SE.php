...
$t['A service error occurred [1]: %s'] = 'Ett servicefel inträffade [1]: %s';
...
$t['year'] = 'år';
$t['years'] = 'år';
$t['youtube-dl uses Python and some servers do not come with python by default. To install Python type:'] = 'youtube-dl använder Python och vissa servrar kommer inte med python som default. För att installera Python skriv:';
