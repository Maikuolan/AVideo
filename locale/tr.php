...
$t['A client error occurred [2]: %s'] = 'Bir istemci hatası oluştu [2]: %s';
$t['A client error occurred: %s'] = 'Bir istemci hatası oluştu: %s';
$t['A service error occurred [1]: %s'] = 'Bir hizmet hatası oluştu [1]: %s';
...
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = 'Kimseye (%s) bilgilendiremedik, ancak uygunsuz olarak işaretledik';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = '%s video sahibini bilgilendiremedik, ancak uygunsuz olarak işaretledik';
...
$t['Your %s locale dir is not writable'] = '%s locale dosyanız yazılabilir değil';
$t['Your Logo'] = 'Logo';
