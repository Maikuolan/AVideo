...
$t['A client error occurred [2]: %s'] = '客戶端錯誤 [2]： %s';
$t['A client error occurred: %s'] = '客戶端錯誤： %s';
$t['A service error occurred [1]: %s'] = '伺服器端錯誤 [1]： %s';
$t['A service error occurred: %s'] = '伺服器端錯誤： %s';
...
$t['Do you want to report this video as inappropriate?'] = '您要舉報此視頻不當嗎？';
...
$t['Help'] = '說明';
$t['Here you can find help, how this platform works.'] = '在這裡您可以找到有關此平台如何工作的幫助。';
...
$t['Some material may not be inappropriate for children under 13'] = '某些材料可能不適合 13 歲以下的兒童';
...
$t["This page works only with an MP4 File, if you have or need any other format, try to install your own <a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>encoder</a> or use the <a href='https://encoder1.avideo.com/' class='btn btn-warning btn-xs'>public</a> one"] = "此網頁僅支援 MP4，如果你需要別的格式，下載並安裝你自己的<a href='https://github.com/WWBN/AVideo-Encoder' class='btn btn-warning btn-xs'>編碼伺服器</a>或使用<a href='https://encoder1.wwbn.net/' class='btn btn-warning btn-xs'>公共編碼伺服器</a>";
...
$t['Watching Now'] = '正在看';
$t['We could not notify anyone (%s), but we marked it as inappropriate'] = '我們無法通知任何人 (%s)，但我們將其標記為不當';
$t['We could not notify the video owner %s, but we marked it as inappropriate'] = '我們無法通知視頻所有者 %s，但我們將其標記為不當';
...
$t['You already reported this video'] = '您已舉報此視頻';
...
$t['Your %s locale dir is not writable'] = '%s locale 目錄無法寫入';
$t['Your Logo'] = '您的商標';
